//! Define the StatusParser struct.
//!
//! This struct contain the necessary regular expressions and algorithm to
//! parse the status information from the dome controller into a Status struct.
